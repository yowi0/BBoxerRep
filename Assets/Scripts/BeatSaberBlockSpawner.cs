   ...
   private void SpawnBlock(BeatSaberBlockData blockData)
{
    ...
    // Generar una posición aleatòria dins d'un rang especificat
    Vector3 randomPosition = spawnPoint.position + new Vector3(
        Random.Range(-horizontalSpacing, horizontalSpacing),
        Random.Range(-verticalSpacing, verticalSpacing),
        0); // Es manté la profunditat constant
    ...
    public class BeatSaberBlockData
    {
        ...
        public int _type;
        public int _cutDirection; // Ara no s'utilitza
    }
